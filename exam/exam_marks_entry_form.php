...
<div class="container-float">  
    ...
    <div class="col-sm-4">
        <form id="myform">
        <div id="show" class="btn btn-sm btn-block btn-primary" style="width:100%; height:auto; padding:0.5em; " ><h4>Click to Show / Hide general inputs</h4></div>
            ...
            <div class="main_input_form" style="width:auto; height:auto; padding:0.5em; background-color:#154360; align: center;">
                ...
                <div class="row" style="width: auto; padding:3em;">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-sm">
                            <span for="Exam" class="input-group-addon" id="sizing-addon1">Exam</span>
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-sm">
                            <span for="Class" class="input-group-addon" id="sizing-addon1">Class</span>
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-sm">
                            <span for="Group" class="input-group-addon" id="sizing-addon1">Group</span>
                            <select id="Group" name="Group" class="form-control selectpicker" data-mobile="true" aria-describedby="sizing-addon1">
                                <option selected value="">Select group</option>
                                <?php
                                $query = $link->query("SELECT * FROM st_group");
                                //Count total number of rows
                                $rowCount = $query->num_rows;
                                if($rowCount > 0){
                                    while($row = $query->fetch_assoc()){ 
        ...
        <div style="width:auto; height:auto; padding:1em; background-color:#ecf2f9; align: center;">
            ...
            <div class="row" style="width:auto; padding:3em;">
                <div class="form-group">
                    <div class="input-group input-group-sm">
                        <span for="studentid" class="input-group-addon" id="sizing-addon1">Student roll </span>
                            <input type="text" id="Roll" name="Roll"  onkeypress="return isNumberKey(event)" class="form-control" tabindex="0" autofocus aria-describedby="sizing-addon1">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <button type = "button" class="btn btn-sm btn-block btn-primary" id = "button" onclick="$('#Roll')[0].focus()"  value = "Add" aria-describedby="sizing-addon1"> Submit </button>
                </div>
            </div>
        </div>
        </form>
