...
<h2>Student Searching</h2>
    <form class="form-horizontal" action="atdn_print_class_wise_student_search.php" role="form" method="get">
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select id="session" class="form-control selectpicker" data-mobile="true" name="session">
                            <?php 
                            $sqlyear="SELECT distinct ss_year FROM st_session ORDER BY ss_year DESC"; 
