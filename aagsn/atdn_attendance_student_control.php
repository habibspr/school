...
<hr>
    ...
    <?php
    if(isset($_POST['status'])){ // Fetching variables of the form which travels in URL
        ...
        if($status!=''){
            if($studentid !=''){
                ...
                if( mysqli_num_rows($result) > 0) {
                    if ($status =='Active'){
                        mysqli_query($link, "UPDATE student_info SET st_status='0' WHERE st_id='$studentid'");
                    }else{
                        mysqli_query($link, "UPDATE student_info SET st_status='1' WHERE st_id='$studentid'");
                    }?>
    <div class="row">
        <div class="col-sm-12">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="alert alert-success fade in">
                <a href="" class="close" data-dismiss="alert">&times;</a>
                <strong>Notice ! </strong>.....Please Select <strong>Active</strong> or<strong>Inactive</strong>
            </div>
        </div>
    </div>
    <?php 
