                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">   
                            <tr>
                                ...
                                <th class="text-center" style="vertical-align:middle;" > Grand Security Status </th>
                            </tr>
                            <?php
                            $Counter=1;
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align:middle;" ><?php $Security_Status=$row['asec_grand_status']; if($Security_Status==0){echo"Unlocked"; }else{echo "Locked";} } ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
